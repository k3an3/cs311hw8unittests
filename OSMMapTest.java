...
import cs311.hw8.parser.OSMMap;
...
public class OSMMapTest {
    ...
    public void testgetDistance() {
        assertEquals(0.0, OSMMap.getDistance(42.990967, -71.463767, 42.990967, -71.463767));
        // Increase delta if needed
        assertEquals(5.52, OSMMap.getDistance(42.910970, -71.463767, 42.990967, -71.463767), 0.1);
    }
}
